...
RETURNS jsonb AS $FUNCTION$
   SELECT fhirbase_create(resource, nextval('fhirbase.transaction_id_seq'));
...
RETURNS jsonb AS $FUNCTION$
   SELECT fhirbase_update(resource, nextval('fhirbase.transaction_id_seq'));
$FUNCTION$ LANGUAGE sql;
...
RETURNS jsonb AS $FUNCTION$
   SELECT fhirbase_delete(resource_type, id, nextval('fhirbase.transaction_id_seq'));
$FUNCTION$ LANGUAGE sql;
